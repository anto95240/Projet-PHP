...
// function validDéco() {
//   $x = "";
//   $r = confirm("Voulez-vous vous déconnecter?");
//   if (r == true) {
//       $x = "You pressed OK!";
//   }
          ...
          <ul class="nav-tabs navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="/src/user/connexion.php">Se connecter</a></li>
                <li><a class="dropdown-item" href="/src/user/inscription.php">Voir mon profil</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="/src/user/déconnexion.php">Se déconnecter</a></li>
              </ul>
            </li>
            <li class="nav-item">
